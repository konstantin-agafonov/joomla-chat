...
function Chat() {
    const [messages, setMessages] = useState([
        ...
        },
        {
            ...
            type: "text",
            title: "Помощник",
            text: "не позднее 90 дней после достижения 14-летнего, 20-летнего или 45-летнего возраста;\nне позднее 30 дней после изменения гражданином в установленном порядке фамилии, имени, отчества, изменением сведений о дате (число, месяц, год) и/или месте рождения; изменения пола",
        },
    ]);
